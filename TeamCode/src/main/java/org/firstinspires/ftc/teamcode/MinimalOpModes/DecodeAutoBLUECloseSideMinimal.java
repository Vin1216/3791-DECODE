...
@Disabled
@Autonomous
public class DecodeAutoBLUECloseSideMinimal extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if(opModeIsActive()) {
            myTimer.reset();
            while(myTimer.milliseconds() < 3100) {
            ...
            GreenWheel1.setVelocity(2800*0.38);
            GreenWheel2.setVelocity(2800*0.38);
