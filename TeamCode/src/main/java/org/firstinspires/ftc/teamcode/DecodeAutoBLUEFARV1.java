...
@Autonomous
public class DecodeAutoBLUEFARV1 extends LinearOpMode {
...
//        }
        ...
        if(opModeIsActive()) {
            ...
            TrajectoryActionBuilder firstSet = PreloadTraj.fresh()
                    .splineToLinearHeading(new Pose2d(44,-30,Math.toRadians(90)),Math.toRadians(270));
            ...
            Actions.runBlocking(
                    drive.actionBuilder(drive.localizer.getPose())
                            .splineToLinearHeading(new Pose2d(60,-12,Math.toRadians(215)), Math.toRadians(30))
                            .build()
            );
            ...
            TrajectoryActionBuilder secondSet = drive.actionBuilder(drive.localizer.getPose())
                    .splineToLinearHeading(new Pose2d(20,-30,Math.toRadians(90)),Math.toRadians(270));
            ...
            Actions.runBlocking(
                    drive.actionBuilder(drive.localizer.getPose())
                            .splineToLinearHeading(new Pose2d(60,-14,Math.toRadians(220)), Math.toRadians(30))
                            .build()
            );
