package org.firstinspires.ftc.teamcode.AutoV1;
...
@Disabled
@Autonomous(name = "CenterstageBlueRightAuto (Blocks to Java)")
public class CenterstageBlueRightAuto extends LinearOpMode {
  ...
  private void MoveTowardAprilTag(int reqID) {
    ...
    IMU_Telemetry();
    if (myAprilTagPoseX != null) {
      targetBearing = Z_Rotation - Math.abs(myAprilTagPoseBearing * 1.15);
